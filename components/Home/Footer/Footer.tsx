        ...
        <div className='w-[80%] mx-auto items-start grid-cols-1 sm:grid-cols-2 grid md:grid-cols-2 lg:grid-cols-4 gap-10'>
            ...
            <div>
                ...
                <div className='mt-6'>
                    ...
                    <h1 className='text-base font-bold text-blue-950 mt-1'>7288945110</h1>
                </div>
                <div className='mt-6'>
                    <h1 className='text-sm text-gray-600'>Our Email</h1>
                    <h1 className='text-base font-bold text-blue-950 mt-1'>info@gmail.com</h1>
                </div>
            </div>
        </div>
        {/* Bottom Section */}
        <div className='mt-8 w-[80%] mx-auto border-t pt-8 flex flex-col md:flex-row justify-between items-center text-gray-600 text-sm'>
            <p className='text-center md:text-left'>Copyright © 2025 Karun.All rights reserved</p>
            <div className='flex items-center space-x-4 mt-4 md:mt-0'>
                ...
                <Link href="#" className="text-gray-500 hover:text-gray-800"><FaYoutube /></Link>
            </div>
        </div>
    </div>
  )
