  ...
  return (
    <div className='bg-black pt-16 pb-16 flex items-center justify-center w-full flex-col'>
        ...
        <div className='w-full'>
            ...
            <button className='px-6 py-3.5 bg-[var(--brand)] text-white hover:bg-[var(--brand)]/50 transition-all duration-200 mt-3 w-[95%] sm:w-[80%] md:w-[60%] lg:w-[40%] block mx-auto rounded-lg outline-none'>Subscribe</button>
        </div>
    </div>
  )
}
